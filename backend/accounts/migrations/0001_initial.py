    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('theme_preference', models.CharField(choices=[('light', 'Light'), ('dark', 'Dark'), ('system', 'System Default')], default='system', max_length=10)),
                ('email_notifications', models.BooleanField(default=True)),
                ('sms_notifications', models.BooleanField(default=False)),
                ('push_notifications', models.BooleanField(default=True)),
                ('is_email_verified', models.BooleanField(default=False)),
                ('verification_token', models.CharField(blank=True, max_length=255)),
                ('user_type', models.CharField(choices=[('public', 'Public User'), ('agency', 'Agency User'), ('admin', 'System Administrator'), ('analyst', 'Crime Analyst')], default='public', max_length=20)),
